<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<footer>
		...
		<div class="footer-bar">
			<div class="container">
				<span class="copyright">Copyright &copy; git LLC . All Rights
					Reserved.</span> <a class="toTop" href="#topNav">BACK TO TOP 
		...
		<!-- footer content -->
		<div class="footer-content" style="height: 360px;">
			<div class="container">
				<div class="row">
					<!-- FOOTER CONTACT INFO -->
						...
						<address class="font-opensans">
							<ul>
								...
								<li class="footer-sprite email">
									<a href="mailto:support@yourname.com">FoodSearch@right.now</a>
								</li>
							</ul>
						</address>
					...
					<div class="column col-md-4 text-right">
						...
						<a href="blog-masonry-sidebar.html" class="view-more pull-right">
							View Blog<i class="fa fa-arrow-right"></i>
						</a>
					</div>
					<!-- /FOOTER LATEST POSTS -->
				</div>
