...
<div id="filter_info_window"
		style="position: fixed; background-color: gray; width: 480px; min-height: 525px; top: 40px; left: 0px; z-index: 999; border: solid black 2px; border-radius: 5px; display: none;">
					...
					<div class="panel-body">
						...
						<ul class="nav nav-tabs">
							...
							<!-- <a data-toggle="tab" href="#profile2">. . .</a> -->
								<div class="btn-group">
									<button id="btnGroupVerticalDrop1" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="width: 59px;">
								...
								<div id="gangnam" class="tab-pane active">
									<div class="btn-row">
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="강남역">
													강남역 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="가로수길">
													가로수길 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="신사/압구정">
													신사/압구정 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="청담동">
													청담동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="신천/잠실">
													신천/잠실 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="여의도">
													여의도 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="역삼/선릉">
													역삼/선릉 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="교대/서초">
													교대/서초 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="삼성동">
													삼성동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="논현동">
													논현동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="서래마을">
													서래마을 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="동작/사당">
													동작/사당 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="방배/반포/잠원">
													방배/반포/잠원 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="관악구">
													관악구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="영등포구">
													영등포구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="송파/가락">
													송파/가락 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="대치동">
													대치동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="강남기타">
													강남 기타 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="도곡동">
													도곡동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="양재동">
													양재동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="구로구">
													구로구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="목동">
													목동/양천 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="방이동">
													방이동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="강동구">
													강동구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="개포/수서/일원">
													개포/수서/일원 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="등촌/강서">
													등촌/강서 </label> <label class="btn btn-custized col-sm-4"> <input
										...
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="홍대">
													홍대 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="이태원/한남동">
													이태원/한남동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광화문">
													광화문 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="신촌/이대">
													신촌/이대 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="마포">
													마포 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="종로">
													종로 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="대학로/혜화">
													대학로/혜화 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="건대/군자/광진">
													건대/군자/광진 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="명동/남산">
													명동/남산 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="삼청/인사">
													삼청/인사 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="중구">
													중구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value=" 시청/남대문">
													시청/남대문 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="왕십리/성동">
													왕십리/성동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="용산/숙대">
													용산/숙대 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="노원/중랑">
													노원/중랑 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value=" 성북구">
													성북구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="동부이촌동">
													동부이촌동 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="수유/도봉/강북">
													수유/도봉/강북 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="동대문구">
													동대문구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="은평구">
													은평구 </label> <label class="btn btn-custized col-sm-4"> <input
										...
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천연수구">
													인천연수구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천부평구">
													인천부평구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천남동구">
													인천남동구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천남구">
													인천남구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천서구">
													인천서구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천동구">
													인천동구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천계양구">
													인천계양구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천중구">
													인천중구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="인천강화군">
													인천강화군 </label> <label class="btn btn-custized col-sm-4"> <input
										...
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="성남시">
													성남시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="고양시">
													고양시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="수원시">
													수원시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="용인시">
													용인시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="안양시">
													안양시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부천시">
													부천시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광명시">
													광명시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="화성시">
													화성시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="구리시">
													구리시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="파주시">
													파주시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="평택시">
													평택시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="하남시">
													하남시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광주시">
													광주시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="가평군">
													가평군 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="의정부시">
													의정부시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="시흥시">
													시흥시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="양평군">
													양평군 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="과천시">
													과천시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="김포시">
													김포시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="이천시">
													이천시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="의왕시">
													의왕시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="포천시">
													포천시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="여주시">
													여주시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="오산시">
													오산시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="동두천시">
													동두천시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="안성시">
													안성시 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="양주시">
													양주시 </label> <label class="btn btn-custized col-sm-4"> <input
										...
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산해운대구">
													부산해운대구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산진구">
													부산진구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산중구">
													부산중구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산금정구">
													부산금정구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산동래구">
													부산동래구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산남구">
													부산남구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산수영구">
													부산수영구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산사하구">
													부산사하구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산기장군">
													부산기장군 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산연제구">
													부산연제구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산사상구">
													부산사상구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산북구">
													부산북구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산동구">
													부산동구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산영도구">
													부산영도구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="부산강서구">
													부산강서구 </label> <label class="btn btn-custized col-sm-4"> <input
										...
										<div class="btn-group" data-toggle="buttons">
											<label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광주광산구">
													광주광산구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광주서구">
													광주서구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광주북구">
													광주북구 </label> <label class="btn btn-custized col-sm-4"> <input
												type="checkbox" name="location_checkbox" value="광주동구">
													광주동구 </label> <label class="btn btn-custized col-sm-4"> <input
